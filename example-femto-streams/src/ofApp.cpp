...
void ofApp::draw()
{
	...
	{
		if (kinectDevice.getColorTex().isAllocated()) kinectDevice.getColorTex().draw(0, 0, 1280, 720);
		if (kinectDevice.getDepthTex().isAllocated()) kinectDevice.getDepthTex().draw(1280, 0, 360, 360);
		if (kinectDevice.getIrTex().isAllocated()) kinectDevice.getIrTex().draw(1280, 360, 360, 360);
	}
